...
import RedwoodCalculator from '../../components/RedwoodCalculator';
...
import styles from './Cameras.css';
...
const Calculator = SortableElement(({
  ...
  switch (cameraType) {
    ...
    case 'redwood':
      return <RedwoodCalculator cameraId={id} />;
...
class Cameras extends Component {
      ...
      return (
        <div className={`${styles.buttonsContainer} ${styles.blockButtonsContainer}`}>
          <div className={`${styles.buttonContainer} ${styles.blockButtonContainer}`}>
            <div className={styles.buttonContainerText}>REDWOOD</div>
            <button type='button' className={styles.redwoodButton} onClick={() => this.props.handleAdd('redwood')}>
              +
            </button>
          </div>
          <div className={`${styles.buttonContainer} ${styles.blockButtonContainer}`}>
  ...
  render = () => {
    ...
    const text = `Please select a camera type above to add a calculator.
    Configure the calculator to determine the frame rate, data rate, or recording time of the camera.`;
