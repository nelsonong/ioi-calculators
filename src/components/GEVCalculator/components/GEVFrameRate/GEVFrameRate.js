...
import { updateFrameRate } from '../../../../actions/gevActions';
import styles from './GEVFrameRate.css';
...
export default connect(mapStateToProps, mapDispatchToProps)(GEVFrameRate);