...
import { updateResolution } from '../../../../actions/customSDIActions';
import styles from './CustomSDIResolution.css';

const CustomSDIResolution = ({
  resolution,
  resolutions,
  handleChange,
}) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(CustomSDIResolution);
