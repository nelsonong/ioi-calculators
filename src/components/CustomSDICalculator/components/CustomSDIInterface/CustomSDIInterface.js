...
import { updateInterface } from '../../../../actions/customSDIActions';
import styles from './CustomSDIInterface.css';

const CustomSDIInterface = ({
  sdiInterface,
  sdiInterfaces,
  handleChange,
}) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(CustomSDIInterface);
