...
const calculateSubSamplingBinningFrameRate = (model, height, bitDepth, linkSpeed, linkCount, subSamplingBinning) => {
...
const calculateDriveModeFrameRate = (height, bitDepth, linkSpeed, linkCount, sensorDriveMode) => {
  ...
  if (sensorDriveMode === SENSOR_DRIVE_MODE.ALL_12) { // Mode 0
    if (isConfiguration(linkSpeed, linkCount, 5, 2) || isConfiguration(linkSpeed, linkCount, 6, 2)) {
      ...
      const hmaxMod = 3;
      const adcBitRatio = (bitDepth === 8 ? 43691 : 54614) / 65536.0;
