...
} from '../components/Core2Calculator/constants';
...
const core2Reducer = (state = { order: [] }, action) => {
  const {
    dvrId,
    type,
  } = action;
  ...
  switch (type) {
    ...
    case UPDATE_CORE2_CONFIGURATION: {
    ...
    case REVERT_CORE2_CAMERA_STATE: {
      const {
        cameraId,
        cameraState,
      } = action;
    ...
    case DUPLICATE_CORE2_CAMERA_STATE: {
      const { cameraId } = action;
    ...
    case UPDATE_CORE2_DRIVE_AMOUNT: {
