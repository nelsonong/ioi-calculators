...
const UPDATE_VOLUCAM_FIRMWARE = 'UPDATE_VOLUCAM_FIRMWARE';
const UPDATE_VOLUCAM_SCALING = 'UPDATE_VOLUCAM_SCALING';
const UPDATE_VOLUCAM_DUAL_GAIN = 'UPDATE_VOLUCAM_DUAL_GAIN';
...
export const updateFirmware = (cameraId, firmware) => ({
  type: UPDATE_VOLUCAM_FIRMWARE,
  cameraId,
  firmware,
});

export const updateScaling = (cameraId, scaling) => ({
  type: UPDATE_VOLUCAM_SCALING,
  cameraId,
  scaling,
});

export const updateDualGain = (cameraId, dualGain) => ({
  type: UPDATE_VOLUCAM_DUAL_GAIN,
  cameraId,
  dualGain,
});
