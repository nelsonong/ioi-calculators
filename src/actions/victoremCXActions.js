...
const UPDATE_VICTOREM_CX_MODEL_FILTERS = 'UPDATE_VICTOREM_CX_MODEL_FILTERS';
...
export const updateModelFilters = (cameraId, modelFilter, enabled, dvrId) => ({
  type: UPDATE_VICTOREM_CX_MODEL_FILTERS,
  cameraId,
  modelFilter,
  enabled,
  dvrId,
